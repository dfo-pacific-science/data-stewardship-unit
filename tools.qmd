...
- Package-first guidance: [Salmon data package + SPSR intake path](reference_info/data_standards/ontology-data-package-gpt.qmd)
...
- Intake guidance: [Salmon data package + SPSR intake path](reference_info/data_standards/ontology-data-package-gpt.qmd)
...
- Typical validation target: `metadata/column_dictionary.csv`
