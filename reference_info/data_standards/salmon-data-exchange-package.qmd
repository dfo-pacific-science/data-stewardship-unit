...
Project-specific helper scripts should live in the repo that owns the workflow
(for example, the CU escapement cookbook), not in the FADS Open Science Hub repo.
