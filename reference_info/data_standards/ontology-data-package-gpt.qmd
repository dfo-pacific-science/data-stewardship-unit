...
<div class="status-badge-row">
  ...
  <span class="status-badge status-canonical">Ontology + salmon data package required</span>
...
3. Assemble package files using [Salmon data package specification](salmon-data-exchange-package.qmd).
