...
The **DFO Salmon Ontology** provides formal definitions for salmon concepts, measurement types, demographic units, life stages, and other domain terms. It is paired with **ontology documentation and contributor guidebook** extracted into human‑friendly tables. These vocabularies provide stable identifiers (IRIs) that can be referenced directly in datasets.
...
For controlled vocabularies, see: [GC DFO Salmon Ontology documentation](../ontology/formal-documentation.qmd).
