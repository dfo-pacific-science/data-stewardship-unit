...
If you are preparing a dataset package and uploading to SPSR, use [Salmon data package + guided review + SPSR intake path](../reference_info/data_standards/ontology-data-package-gpt.qmd).
:::
