...
Use this workflow when you need to **add, revise, or align controlled terms** used in salmon datasets, SDEP metadata, and SPSR uploads.

::: {.callout-note}
This workflow is for **term governance**.

If you are preparing a dataset package and uploading to SPSR, use [SDEP + SPSR Intake Path](../reference_info/data_standards/ontology-data-package-gpt.qmd).
:::
...
- impact on SDEP and SPSR is documented
...
- update SDEP templates (`column_dictionary.csv`, `codes.csv` examples)
...
- [ ] Downstream SDEP/SPSR impacts assessed
