...
In the DFO Pacific Region, diverse data formats and schemas are used across programs, divisions, and systems. Darwin Core provides a **shared vocabulary** that enables these internal formats to be mapped to:
