...
Use [GC DFO Salmon Ontology (WIDOCO)](https://w3id.org/gcdfo/salmon) plus the [metasalmon reusing-standards vignette](https://dfo-pacific-science.github.io/metasalmon/articles/reusing-standards-salmon-data-terms.html) to map core columns to canonical IRIs.
