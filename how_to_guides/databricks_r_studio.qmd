...
format: 
  html: 
    code-overflow: wrap
redirect_from:
  - /documentation_hub/how_to_guides/databricks_r_studio
freeze: auto
eval: false
---
...
0. Request an account on the DFO Azure Databricks workspace (EDH Subscription) by submitting an email to DFO.PACStrategicData-DonneesStrategiquesPAC.MPO@dfo-mpo.gc.ca Copy, Paste this template request and replace the [placeholders] with your information:
...
1. In [Databricks Web UI](https://adb-553282681420861.1.azuredatabricks.net/) > go to your profile page and navigate to
...
![Databricks Token](../images/databricks_rstudio/databricks_token.jpg) 
...
5. Go to ‘Connection details’ > JDBC URL and copy the string

![JDBC Driver](../images/databricks_rstudio/JDBC_URL.jpg)
...
## Local Compute versus Databricks Compute
