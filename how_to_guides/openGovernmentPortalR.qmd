...
Then, under the **Data and Resources** section, find the item labelled **ESRI REST** (there is both an English and French example). Left click on **Explore**, then right click on **Go to resource** and left click on **Copy link**. This then copies the link to the URL you need.
