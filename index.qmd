...
<section class="home-hero">
  ...
  <div class="home-cta-row">
    <a class="home-cta home-cta-primary" href="reference_info/data_standards/semantic-salmon-system.html">Start with the Salmon Data Integration System</a>
...
<div class="home-card-grid">
  <a class="home-card" href="reference_info/data_standards/semantic-salmon-system.html">
    <h3>Start the data integration system path</h3>
    <p>Follow the canonical sequence: ontology → salmon data package → metasalmon → guided review (optional) → SPSR.</p>
  </a>
  ...
  <a class="home-card" href="reference_info/data_standards/salmon-data-exchange-package.html">
    <h3>Build a salmon data package</h3>
    <p>Use the salmon data package specification and starter artifacts.</p>
  </a>
...
<div class="home-path-shelf">
  <a class="home-path-card" href="reference_info/data_standards/semantic-salmon-system.html">
    ...
    <h3>Data integration system path</h3>
