...
Take a snippet of a database schema or a data file that your team regularly publishes, shares, or struggles to interpret, and use the [`metasalmon` quickstart](https://dfo-pacific-science.github.io/metasalmon/articles/metasalmon.html) to create a review-ready package first. If you need help with ambiguous mappings or possible term gaps, bring that package or a representative sample into [`smn-gpt`](https://github.com/dfo-pacific-science/smn-gpt) or another constrained guided assistant for review. Then inspect what terms are already standardized, identify what is not yet covered, and propose additions to the [DFO salmon data standards](https://dfo-pacific-science.github.io/data-stewardship-unit/reference_info/data_standards/index.html) where needed.
...
- [`smn-gpt` guided assistant layer](https://github.com/dfo-pacific-science/smn-gpt)
